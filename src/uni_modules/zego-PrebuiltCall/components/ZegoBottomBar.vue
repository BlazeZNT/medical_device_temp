...
import { zlogerror, zloginfo, zlogwarning } from '@/uni_modules/zego-UIKitCore'
...
const getDisplayButtons = () => {
    ...
    const needMoreButton = props.menuBarButtons.length > maxCount;

    props.menuBarButtons.forEach(buttonIndex => {

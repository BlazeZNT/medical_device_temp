<template>
    <ZegoImageButton @click="onButtonPress" :disabled="!isEnable"  :image="imageSource" :width="width" :height="height" />
</template>
...
import EarpieceImg from '../../assets/images/white_button_speaker_off@2x.png';
import SpeakerImg from '../../assets/images/white_button_speaker_on@2x.png';
import BluetoothImg from '../../assets/images/white_button_bluetooth_off@2x.png';

...
import MicOnImg from '../../assets/images/white_icon_video_mic_on@2x.png';
import MicOffImg from '../../assets/images/white_icon_video_mic_off@2x.png';
import SpeakingImg from '../../assets/images/white_icon_video_mic_speaking@2x.png';

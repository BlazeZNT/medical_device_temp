import { ZegoRoomStateChangedReason } from "./express/ZegoExpressUniApp";
/**
 * 用户信息接口，用于描述房间内的用户状态。
 */
export declare class ZegoUIKitUser {
    userID: string;
    userName?: string;
    isCameraOn?: boolean;
 ...
 * 预设分辨率枚举。
 */
export declare enum ZegoPresetResolution {
    Preset180p = 0,
    Preset270p = 1,
    Preset360p = 2,
    Preset540p = 3,
 ...
 */
export declare enum ZegoInRoomMessageState {
    Idle = 0,
    Sending = 1,
    Success = 2,
    Failed = 3
 ...
 */
export declare enum ZegoAudioVideoResourceMode {
    Default = 0,
    CdnOnly = 1,
    L3Only = 2,
    RtcOnly = 3,
 ...
 */
export declare enum ZegoAudioOutputDevice {
    Speaker = 0,
    Headphone = 1,
    Bluetooth = 2,
    EarSpeaker = 3,

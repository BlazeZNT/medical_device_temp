...
export declare class ZegoExpressEngineImpl {
    ...
    setVideoSource(source: ZegoVideoSourceType, channel?: ZegoPublishChannel): Promise<number>;
    setAudioSource(source: ZegoAudioSourceType, channel?: ZegoPublishChannel): Promise<number>;
    ...
    startScreenCaptureInApp(config?: ZegoScreenCaptureConfig): Promise<void>;
    startScreenCapture(config?: ZegoScreenCaptureConfig): Promise<void>;
    updateScreenCaptureConfig(config: ZegoScreenCaptureConfig): Promise<void>;

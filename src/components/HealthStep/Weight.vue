<template>
  <ContentBox>
    <view style="display: flex; flex-direction: column; align-items: center">
      ...
      <HelperBox @next="handleClickNext" img="../../static/health/healper/1.png" tips="1.Stand on the weight measurement device<br />2.Press the start button on the device" v-if="showHeapler"></HelperBox>
    </view>
  </ContentBox>
</template>

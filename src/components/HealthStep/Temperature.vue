    ...
    <view style="display: flex; flex-direction: column; align-items: center">
      ...
      >
        <view class="sitchBtn">
          <view
            class="sitchBtn-item"
            :class="kedu == 'KG' ? 'active' : ''"
            @click="handleClickKedu('KG')"
            >°F
          </view>
          <view
            class="sitchBtn-item"
            :class="kedu == 'LBS' ? 'active' : ''"
            @click="handleClickKedu('LBS')"
          >
            °C</view
          >
        </view>
      ...
      <HelperBox img="../../static/health/healper/3.png" :tips="tips" @next="handleClickNext" v-if="showHeapler"></HelperBox>
    </view>
  </ContentBox>
</template>
...
const tips = `1.Place thermometer at the center of the<br /> forehead, just above the eyebrows. <br /> Ensure the sensor touches the skin lightly.<br>2.Press the start button  on the device`

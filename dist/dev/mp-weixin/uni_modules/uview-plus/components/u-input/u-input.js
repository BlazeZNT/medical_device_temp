...
const _sfc_main = {
    ...
    modelValue: {
      ...
      handler(newVal, oldVal) {
        ...
        if (this.firstChange === false && this.changeFromInner === false) {
          ...
          if (!this.firstChange) uni_modules_uviewPlus_libs_function_index.f(this, "change");
        }
  ...
  computed: {
    ...
    inputStyle() {
      const style = {
        color: this.color,
        fontSize: uni_modules_uviewPlus_libs_function_index.a(this.fontSize),
  ...
  methods: {
    ...
    onBlur(event) {
      ...
      uni_modules_uviewPlus_libs_function_index.s(150).then(() => {
        this.focused = false;
      });
      uni_modules_uviewPlus_libs_function_index.f(this, "blur");
    },
    // 输入框聚焦时触发
    onFocus(event) {
      this.focused = true;
    ...
    valueChange(value, isOut = false) {
      ...
      this.$nextTick(() => {
        ...
        uni_modules_uviewPlus_libs_function_index.f(this, "change");
      });
    },
    // 点击清除控件
    onClear() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.P({
    ...
    c: common_vendor.Q($options.inputStyle),
    d: _ctx.type,
    e: _ctx.focus,
    f: _ctx.cursor,
    g: $data.innerValue,
    ...
    x: common_vendor.J((...args) => $options.onInput && $options.onInput(...args)),
    y: common_vendor.J((...args) => $options.onBlur && $options.onBlur(...args)),
    z: common_vendor.J((...args) => $options.onFocus && $options.onFocus(...args)),
    A: common_vendor.J((...args) => $options.onConfirm && $options.onConfirm(...args)),
    B: common_vendor.J((...args) => $options.onkeyboardheightchange && $options.onkeyboardheightchange(...args)),
    ...
    F: common_vendor.J((...args) => $options.onClear && $options.onClear(...args))
  } : {}, {
    ...
    I: common_vendor.S($options.inputClass),
    J: common_vendor.Q($options.wrapperStyle)
  });
}
const Component = /* @__PURE__ */ common_vendor.H(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-a5e5d5c3"]]);
